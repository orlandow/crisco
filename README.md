...
get the app created:
    ...
    $ heroku apps:create crisco
    Creating crisco... done, stack is cedar
    http://crisco.herokuapp.com/ | git@heroku.com:crisco.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://crisco.herokuapp.com deployed to Heroku

    To git@heroku.com:crisco.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://crisco.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@crisco.herokuapp.com/repl
